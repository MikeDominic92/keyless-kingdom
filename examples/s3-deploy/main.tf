# Example: Deploy static website to S3 using GitHub Actions with OIDC
# This demonstrates a complete S3 deployment using keyless authentication
...
resource "aws_cloudfront_distribution" "website" {
  ...
  comment             = "Static website distribution for ${var.bucket_prefix}"
